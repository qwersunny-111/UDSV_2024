...
#         input1_name = batch_value[2][0]
#         input2_name = batch_value[3][0]
...
#         with torch.no_grad():
#             batch_out = build_output_model(net, input1_tensor, input2_tensor)
...
#         # Save images with the same names as input images
#         path = os.path.join(path_warp1, input1_name)
#         cv2.imwrite(path, final_warp1)
#         path = os.path.join(path_warp2, input2_name)
#         cv2.imwrite(path, final_warp2)
#         path = os.path.join(path_mask1, input1_name)
#         cv2.imwrite(path, final_warp1_mask * 255)
#         path = os.path.join(path_mask2, input2_name)
#         cv2.imwrite(path, final_warp2_mask * 255)
...
def test(args):
    ...
    for i, batch_value in enumerate(test_loader):
        ...
        # Save images with the same names as input images
        cv2.imwrite(os.path.join(path_warp1, input1_name), final_warp1)
        cv2.imwrite(os.path.join(path_warp2, input2_name), final_warp2)
        cv2.imwrite(os.path.join(path_mask1, input1_name), final_warp1_mask * 255)
        cv2.imwrite(os.path.join(path_mask2, input2_name), final_warp2_mask * 255)

        print('Processed image: {}'.format(input1_name))
...
if __name__=="__main__":
    ...
    parser.add_argument('--test_path', type=str, default='/home/B_UserData/sunleyao/UDIS2/video/5/')
