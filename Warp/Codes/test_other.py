...
def train(args):
    ...
    for epoch in range(start_epoch, start_epoch + args.max_iter):
        ...
        if current_iter == 1:
            ...
            cv2.imwrite( args.path+ 'warp2_mesh.jpg', output['warp2_mesh'])
...
if __name__=="__main__":
    ...
    parser.add_argument('--path', type=str, default='/home/sunleyao/sly/UDIS2-main/UDIS2++-experiment-visualMesh/two_imgs20240912/72/')
