...
class Network(nn.Module):
    ...
    def forward(self, input1_tesnor, input2_tesnor):
        ...
        # # 保存大图到指定路径
        # save_path = '/home/sunleyao/sly/UDIS2-main/UDIS2-main-y-5/Warp/feature_23-1_extra1.png'
        ...
        feature_map_np = warp_feature_2_64.detach().cpu().numpy()
        ...
        # 创建保存特征图的目录
        save_dir = '/home/sunleyao/sly/UDIS2-main/UDIS2-main-y-5/Warp/feature_maps_warp'
        if not os.path.exists(save_dir):
            os.makedirs(save_dir)
