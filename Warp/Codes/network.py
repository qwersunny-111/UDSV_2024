...
mesh_motion_manager = MeshMotionManager(window_size=51, sigma=25)
...
def build_output_model(net, input1_tensor, input2_tensor):
    ...
    # x = mesh_motion[0, 10, 11, 0]  # 第一个batch的(7,7)位置x坐标
    # y = mesh_motion[0, 10, 11, 1]  # 第一个batch的(7,7)位置y坐标
    # x_positions.append(x)
    # y_positions.append(y)

    # 打印 x_positions 和 y_positions
    ...
    # x = mesh_motion[0, 10, 11, 0]  # 第一个batch的(7,7)位置x坐标
    # y = mesh_motion[0, 10, 11, 1]  # 第一个batch的(7,7)位置y坐标
    # smoothed_x_positions.append(x)
    # smoothed_y_positions.append(y)

    # 打印 x_positions 和 y_positions
    # print("smoothed_x_positions:", smoothed_x_positions)
    # print("smoothed_y_positions:", smoothed_y_positions)
