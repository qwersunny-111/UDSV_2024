...
#     def __getitem__(self, index):
#         # load image1
#         input1_path = self.datas['input1']['image'][index]
#         input1 = cv2.imread(input1_path)
#         input1 = input1.astype(dtype=np.float32)
#         input1 = (input1 / 127.5) - 1.0
#         input1 = np.transpose(input1, [2, 0, 1])
        
#         # load image2
#         input2_path = self.datas['input2']['image'][index]
#         input2 = cv2.imread(input2_path)
#         input2 = input2.astype(dtype=np.float32)
#         input2 = (input2 / 127.5) - 1.0
#         input2 = np.transpose(input2, [2, 0, 1])
...
#         # Extract image names
#         input1_name = os.path.basename(input1_path)
#         input2_name = os.path.basename(input2_path)

#         return (input1_tensor, input2_tensor, input1_name, input2_name)
